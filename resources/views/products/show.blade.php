    ...
    <div class="row mb-3">
        <div class="col-md-6">
            ...
            <input type="text" name="created_at" class="form-control" placeholder="Created At"
                value="{{ $product->created_at->setTimezone('Asia/Bangkok')->format('d/m/Y H:i:s') }} (GMT+7)" readonly>
        </div>
        <div class="col-md-6">
            <label class="form-label">Updated At</label>
            <input type="text" name="updated_at" class="form-control" placeholder="Updated At"
                value="{{ $product->updated_at->setTimezone('Asia/Bangkok')->format('d/m/Y H:i:s') }} (GMT+7)" readonly>
        </div>
    </div>
@endsection
